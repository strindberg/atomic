...
extern const uint16_t fn_actions_4[];

/* Atomic keymap definition macro
 */
#define KEYMAP( \
    ...
    K40, K41,      K43, K44, K45,      K47, K48,      K4A, K4B, K4C, K4D, K4E  \
) { \
    ...
    { KC_##K40, KC_##K41, KC_NO,    KC_##K43, KC_##K44, KC_##K45, KC_NO,    KC_##K47, KC_##K48, KC_NO,    KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E }  \
}
